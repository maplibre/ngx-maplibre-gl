...
#### [Unreleased](https://github.com/maplibre/ngx-maplibre-gl/compare/v19.0.0...HEAD)

- feat: enable experimental zoneless change detection for showcase [`#230`](https://github.com/maplibre/ngx-maplibre-gl/pull/230)
