...
- feat: add `mapStyle` replacing `style` [`#251`](https://github.com/maplibre/ngx-maplibre-gl/pull/251)
- feat: export NgxMapLibreGLImports to simplify standalone imports [`#249`](https://github.com/maplibre/ngx-maplibre-gl/pull/249)
- feat: `signal` and `onPush` component [`#246`](https://github.com/maplibre/ngx-maplibre-gl/pull/246)
- stackblitz zoneless [`#241`](https://github.com/maplibre/ngx-maplibre-gl/pull/241)
- Change interface to type using eslint [`#237`](https://github.com/maplibre/ngx-maplibre-gl/pull/237)
