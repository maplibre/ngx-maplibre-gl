...
`],encapsulation:2})}return a})(),be=(()=>{class a{static \u0275fac=function(t){return new(t||a)};static \u0275mod=L({type:a});static \u0275inj=F({imports:[ce,y,X]})}return a})();var Ie=()=>[4.899,52.372],Ce=()=>({preserveDrawingBuffer:!0}),Ke=(()=>{class a{constructor(){this.layerId=K("streets"),this.style=Z(()=>this.changeStyle(this.layerId()))}changeStyle(e){return e==="streets"?"https://tiles.openfreemap.org/styles/liberty":{version:8,sources:{raster:{type:"raster",tiles:["https://tile.openstreetmap.org/{z}/{x}/{y}.png"],minzoom:0,maxzoom:15,scheme:"xyz",tileSize:256}},layers:[{id:"some-raster-layer-id",type:"raster",source:"raster",layout:{visibility:"visible"},paint:{"raster-opacity":1}}]}}static{this.\u0275fac=function(t){return new(t||a)}}static{this.\u0275cmp=m({type:a,selectors:[["showcase-demo"]],inputs:{layerId:[1,"layerId"]},outputs:{layerId:"layerIdChange"},decls:6,vars:7,consts:[["data-cy","mgl-map",3,"mapStyle","zoom","center","canvasContextAttributes"],["data-cy","radio-group",1,"radio-group",3,"ngModelChange","ngModel"],["value","streets","data-cy","streets-button"],["value","code","data-cy","code-button"]],template:function(t,i){t&1&&(b(0,"mgl-map",0),o(1,"mat-radio-group",1),H("ngModelChange",function(c){return U(i.layerId,c)||(i.layerId=c),c}),o(2,"mat-radio-button",2),D(3,"streets"),s(),o(4,"mat-radio-button",3),D(5,"from code"),s()(),O()),t&2&&(u("mapStyle",i.style())("zoom",13)("center",x(5,Ie))("canvasContextAttributes",x(6,Ce)),l(),Q("ngModel",i.layerId),B())},dependencies:[se,be,S,y,de,oe,ne],styles:["[_nghost-%COMP%]{display:flex;flex:1}mgl-map[_ngcontent-%COMP%]{height:100%;width:100%}",".radio-group[_ngcontent-%COMP%]{position:absolute;padding:8px;background:#fff}"]})}}return a})();export{Ke as SetStyleComponent};
